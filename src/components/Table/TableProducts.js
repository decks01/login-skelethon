...
const getProductById = async (id) => {
  setShow(true);
  try {
    const response = await fetch(constants.api + "products/" + id, {
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    ...
    const result = await response.json();
    console.log(' result De getProduct',result);
    console.log(result);
    setDataModal(result);
    setidProds(result.idProds)
    setidCat(result.idCat)
...
const deleteProduct = async (id) => {
  try {
    const response = await fetch(constants.api + "products/delete/" + id, {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    ...
    if(result){
      ...
      console.log("El producto no se borro");
    }
...
const handleClosecreate = (id) => {
  ...
  const actionBodyTemplate = (rowData) => {
    return (
      <div key={rowData.id}>
          <Button
            icon="pi pi-pencil"
            className="p-button-rounded p-button-success mr-2" onClick={(e) => getProductById(rowData?.idProds)}
          />
          <Button
            icon="pi pi-trash"
            className="p-button-rounded p-button-danger" onClick={(e) => ConfirmAlert(rowData?.idProds)}
          />
      </div>
    );
  };
  ...
  const globalFilters = ["idProds", "idCat", "nombre", "tipo", "stock", "precio", "imagen"];
  ...
  const rows = [
    { field: "idProds", header: "ID" },
    { field: "idCat", header: "ID_Categoria" },
        ...
        {loader ? (
          ...
          <div className="">
            ...
            <Modal show={showcreate} onHide={handleClosecreate}>
              ...
              <div className="mb-3">
                    <label forhtml="exampleFormControlTextarea1" className="form-label">Descripcion</label>
              ...
              <Modal.Footer>
                ...
                <Button variant="primary" onClick={(e) => createProduct(id)}>
                  Create
                </Button>
              </Modal.Footer>
            </Modal>
            ...
            <Modal show={show} onHide={handleClose}>
              ...
              <Modal.Footer>
                ...
                <Button variant="primary" onClick={(e) => updateProduct(id)}>
                  Save Changes
                </Button>
              </Modal.Footer>
            </Modal>
